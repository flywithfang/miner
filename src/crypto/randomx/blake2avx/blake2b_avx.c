...
int blake2b(uint8_t* out, const uint8_t* in, size_t inlen, int b512);
int blake2bavx_512(unsigned char* out, const unsigned char* in, size_t inlen)
{
	return blake2b(out, in, inlen, 1);
}
int blake2bavx_256(unsigned char* out, const unsigned char* in, size_t inlen)
{
	return blake2b(out, in, inlen, 0);
}

int blake2b(uint8_t* out, const uint8_t* in, size_t inlen, int b512) {
	const __m256i parameter_block = b512 ? _mm256_set_epi64x(0, 0, 0, 0x01010040UL) : _mm256_set_epi64x(0, 0, 0, 0x01010020UL);
